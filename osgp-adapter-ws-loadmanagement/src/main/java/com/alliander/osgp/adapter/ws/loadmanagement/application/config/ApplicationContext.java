...
import com.alliander.osgp.ws.loadmanagement.config.LoadManagementWebServiceConfig;
 ...
 */
@Configuration
@ComponentScan(basePackages = { "com.alliander.osgp.domain.core", "com.alliander.osgp.adapter.ws.loadmanagement" })
@EnableTransactionManagement()
@ImportResource("classpath:applicationContext.xml")
@Import({ MessagingConfig.class, PersistenceConfig.class, WebServiceConfig.class,
        LoadManagementWebServiceConfig.class })
