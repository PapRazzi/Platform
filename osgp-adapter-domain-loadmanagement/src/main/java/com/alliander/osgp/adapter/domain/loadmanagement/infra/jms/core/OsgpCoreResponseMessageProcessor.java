 ...
 */
package com.alliander.osgp.adapter.domain.loadmanagement.infra.jms.core;
...
public abstract class OsgpCoreResponseMessageProcessor implements MessageProcessor {
     ...
     */
    @Autowired
    @Qualifier("domainLoadManagementOsgpCoreResponseMessageProcessorMap")
    ...
    protected void handleError(final Exception e, final String correlationUid, final String organisationIdentification,
        ...
        if (e instanceof OsgpException) {
            ...
            osgpException = new TechnicalException(ComponentType.DOMAIN_LOAD_MANAGEMENT, "An unknown error occurred", e);
        }
