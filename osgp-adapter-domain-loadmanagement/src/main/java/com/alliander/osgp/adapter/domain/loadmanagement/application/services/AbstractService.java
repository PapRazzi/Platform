 ...
 */
package com.alliander.osgp.adapter.domain.loadmanagement.application.services;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.beans.factory.annotation.Qualifier;

import com.alliander.osgp.adapter.domain.loadmanagement.application.mapping.DomainLoadManagementMapper;
import com.alliander.osgp.adapter.domain.loadmanagement.infra.jms.core.OsgpCoreRequestMessageSender;
...
public class AbstractService {
    ...
    @Autowired
    @Qualifier(value = "domainLoadManagementOutgoingOsgpCoreRequestMessageSender")
    protected OsgpCoreRequestMessageSender osgpCoreRequestMessageSender;

    @Autowired
    protected DomainLoadManagementMapper domainCoreMapper;

    @Autowired
    @Qualifier(value = "domainLoadManagementOutgoingWebServiceResponseMessageSender")
    ...
    protected Device findActiveDevice(final String deviceIdentification) throws FunctionalException {
        ...
        try {
            ...
            throw new FunctionalException(FunctionalExceptionType.UNREGISTERED_DEVICE,
                    ComponentType.DOMAIN_LOAD_MANAGEMENT, e);
