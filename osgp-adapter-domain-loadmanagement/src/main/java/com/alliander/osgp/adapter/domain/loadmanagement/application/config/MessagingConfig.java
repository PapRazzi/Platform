 ...
 */
package com.alliander.osgp.adapter.domain.loadmanagement.application.config;
...
import com.alliander.osgp.adapter.domain.loadmanagement.infra.jms.OsgpCoreRequestMessageListener;
import com.alliander.osgp.adapter.domain.loadmanagement.infra.jms.core.OsgpCoreResponseMessageListener;
import com.alliander.osgp.adapter.domain.loadmanagement.infra.jms.ws.WebServiceRequestMessageListener;
import com.alliander.osgp.adapter.domain.loadmanagement.infra.jms.ws.WebServiceResponseMessageSender;
 ...
 */
@Configuration
@PropertySources({ @PropertySource("classpath:osgp-adapter-domain-loadmanagement.properties"),
        @PropertySource(value = "file:${osgp/Global/config}", ignoreResourceNotFound = true),
        @PropertySource(value = "file:${osgp/AdapterDomainLoadManagement/config}", ignoreResourceNotFound = true), })
public class MessagingConfig extends AbstractMessagingConfig {

    @Autowired
    @Qualifier("domainLoadManagementIncomingWebServiceRequestMessageListener")
    private WebServiceRequestMessageListener incomingWebServiceRequestMessageListener;

    @Autowired
    @Qualifier("domainLoadManagementIncomingOsgpCoreResponseMessageListener")
    private OsgpCoreResponseMessageListener incomingOsgpCoreResponseMessageListener;

    @Autowired
    @Qualifier("domainLoadManagementIncomingOsgpCoreRequestMessageListener")
    ...
    @Bean(name = "domainLoadManagementIncomingWebServiceRequestMessageListenerContainer")
    ...
    @Bean(name = "domainLoadManagementOutgoingWebServiceResponsesJmsTemplate")
    ...
    @Bean(name = "domainLoadManagementOutgoingWebServiceResponseMessageSender")
    ...
    @Bean(name = "domainLoadManagementOutgoingOsgpCoreRequestsJmsTemplate")
    ...
    @Bean(name = "domainLoadManagementIncomingOsgpCoreResponsesMessageListenerContainer")
    ...
    @Bean(name = "domainLoadManagementIncomingOsgpCoreRequestsMessageListenerContainer")
    ...
    @Bean(name = "domainLoadManagementOutgoingOsgpCoreResponsesJmsTemplate")
